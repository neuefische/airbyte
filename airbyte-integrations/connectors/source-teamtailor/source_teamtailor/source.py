...
from source_teamtailor.streams import Companies, JobApplications, Locations, TeamtailorStream
...
class SourceTeamtailor(AbstractSource):
    ...
    def streams(self, config: Mapping[str, Any]) -> List[Stream]:
        ...
        return [Locations(authenticator=auth), JobApplications(authenticator=auth), Companies(authenticator=auth)]
